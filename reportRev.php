<?php
$select_job = select_job_project_noclose();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-excel').click(function() {
                ...
                worksheet.getColumn(1).width = 11.33;
                worksheet.getColumn(2).width = 13.00;
                worksheet.getColumn(3).width = 13.00;
                worksheet.getColumn(4).width = 13.00;
                worksheet.getColumn(5).width = 14.00;
                worksheet.getColumn(6).width = 21.00;
                worksheet.getColumn(7).width = 37.00;
                worksheet.getColumn(8).width = 12.83;
                worksheet.getColumn(9).width = 10.67;
                worksheet.getColumn(10).width = 9.00;
                worksheet.getColumn(11).width = 9.00;
                worksheet.getColumn(12).width = 9.00;
                worksheet.getColumn(13).width = 9.00;
                worksheet.getColumn(14).width = 9.00;
                worksheet.getColumn(15).width = 9.00;
                worksheet.getColumn(16).width = 9.00;
                worksheet.getColumn(17).width = 9.00;
                worksheet.getColumn(18).width = 6.83;
                worksheet.getColumn(19).width = 13.00;
                ...
                worksheet.getCell('A1').value = 'EN0102-สรุปตาม Job No. (REV)';
                ...
                worksheet.getCell('B3').value = `รหัสงาน`;
                ...
                worksheet.getCell('D3').value = `W/A`;
                ...
                worksheet.getCell('E3').value = `สถานะ`;
                ...
                worksheet.getCell('F3').value = `Rev`;
                ...
                workbook.xlsx.writeBuffer().then((buffer) => {
                    ...
                    link.download = `รายงานบันทึกการเปลี่ยนแปลง-${formattedDate}.xlsx`;
            ...
            $('#search-job').click(function() {
                ...
                $.ajax({
                    url: './select_report_rev?token=<?php echo $_SESSION['token'] ?>',
                    type: 'POST',
                    data: {
                        job_no: job_no,
                        ...
                        for (const [key, value] of Object.entries(response)) {
                            ...
                            html_table += `
                                <tr>
                                    ...
                                    <td colspan="17" class="col-titel">${value[0].project_name}</td>
                                </tr>
                            `;
                            ...
                            value.forEach((item, index) => {
                                ...
                                html_table += `
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-center" style="width: 100px !important;">${item.CR_no}</td>
                                        ...
                                        <td class="text-nowrap text-center" style="width: 250px !important;">${item.doc_status}</td>
                            ...
                            html_table += `
                                <tr>
                                    ...
                                    <td class="col-sum" colspan="5">${value.length}</td>
